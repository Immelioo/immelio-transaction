...
## Blocking before production confidence

- Production deployment still behind local validated code
- Live estimation flow still broken
- Live robots/sitemap still point to Vercel domain
...
- Full route-by-route redirect matrix
